...
ATEM Mini Proは、複数の映像入力を切り替えて出力できるビデオスイッチャーです。

遠隔授業では、教材やカメラなどの映像の切り替えと、教員映像のクロマキー合成に使用します。

詳しい操作方法は、操作する場所に応じて次のページで説明します。

- [本体操作](operation/index.md)
- [ATEM Software Control](software-control/index.md)

## ATEM Mini Pro 本体操作パネル

本体のボタンは、映像・音声の切り替え、合成、録画など、役割ごとにまとまっています。実機の表示と見比べながら確認してください。

![ATEM Mini Pro本体操作パネル](../images/Atem/Atem01.png)
